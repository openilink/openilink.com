...
3. **渠道层**：`openilink-tg`、`openclaw-channel-openilink` —— 外部渠道集成
4. **SDK 层**：`openilink-sdk-node`、`openilink-sdk-php`、`openilink-sdk-go`、`openilink-sdk-python`、`openilink-sdk-csharp`、`openilink-sdk-java` —— 六种语言的接入包
...
- **第一次了解项目**：先看 [Hub](https://hub.openilink.com) 和 [仓库页](/docs/repositories)
...
如果你要快速开始，推荐直接进入 [快速开始](/docs/guide/quick-start)。如果你要开始代码接入，先进入 [SDK 总览](/docs/sdk)。如果你想先看平台表面，直接打开 [Hub](https://hub.openilink.com)。
